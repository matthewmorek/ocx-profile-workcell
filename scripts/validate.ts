...
async function main(): Promise<void> {
  ...
  await invoke([runtime, "run", "scripts/verify-install.ts", "--registry", pages, "--version", version, "--commit", commit, "--evidence-out", evidence, "--diagnostics-dir", join(work, "install-diagnostics")]);
